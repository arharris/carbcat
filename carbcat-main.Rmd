...
warning("The fire data is all in integer format. Deal with that.")
...
study_area_FCID[,':='(Recovered_CWD_tonsAcre = Recovered_Stem9Plus_tonsAcre + Recovered_Stem6to9_tonsAcre + Recovered_Stem4to6_tonsAcre,
...
study_area_FCID[,':='(Recovered_Stem9Plus_tonsAcre = NULL, Recovered_Stem6to9_tonsAcre = NULL, Recovered_Stem4to6_tonsAcre = NULL,
...
if(user_inputs[variable=="biomass_collection",value]!="No") {
  ...
  #######################################################################################################################################
  #######################################################################################################################################
  harvest_processing_output <- harvest_processing_fun(study_area_FCID, high_volume_cell_threshold_density)
...
for (year.i in 1:10) {
  ...
  # AFTER YEAR 2 VERIFICATION - DELETE THIS. SCENARIO MATRIX CHANGES MEAN RECOVERED WILL ALWAYS BE 0.
