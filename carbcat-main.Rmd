...
study_area_FCID[,':='(Piled_CWD_tonsAcre_INITIAL = Piled_CWD_tonsAcre,
...
if(user_inputs[variable=="biomass_collection",value]!="No") {
  ...
  if(user_inputs[variable=='power_plant_location',value]=='Nearest') { # Multiple potential power plant locations
    power_plant_emissions <- power_plant_fun(study_area_FCID, power_emission_factors, unique(study_area_FCID[,plant_location]))
  } else { # Single power plant location
    power_plant_emissions <- power_plant_fun(study_area_FCID, power_emission_factors, user_inputs[variable=='power_plant_location',value])
  }
}
...
for (year.i in 1:100) {
  ...
  if(year.i==1) {
    ...
    if(user_inputs[variable=='burn_type',value] == "Broadcast Burn") {
      prescribed_burn_output <- prescribed_burn_fun(study_area_FCID, "Scattered", user_inputs[variable=='burn_type',value], year.i)
    ...
    if(user_inputs[variable=='burn_type',value] == "Pile Burn") {
      prescribed_burn_output <- prescribed_burn_fun(study_area_FCID, "Piled", user_inputs[variable=='burn_type',value], year.i)
      prescribed_burn_emissions <- prescribed_burn_output[[1]]
      study_area_FCID <- prescribed_burn_output[[2]]
    }
