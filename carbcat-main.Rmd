...
for (year.i in 1:10) {
  ...
  setkey(study_area_FCID,x,y)
  write.csv(study_area_FCID[1:1000,],file="~/Desktop/CBREC debugging/base data csvs/post-decay-year-one-1000rows-scen255.csv",row.names = F)
  ...
  study_area_FCID[,':='(Wildfire_Probability = NULL, CWD_Scattered_CombustionFrac = NULL, FWD_Scattered_CombustionFrac = NULL, Foliage_Scattered_CombustionFrac = NULL, Duff_Scattered_CombustionFrac = NULL, 
